{
  ...
  v1_18 = {
    ...
    src-hash = "sha256-iZbrgWl+2E3eQeitjwpSaA3lLO81MjymyVI/ZoNR2HM=";
  ...
  v1_19 = {
    version = "1.19.6";
    src-hash = "sha256-nCfADrnohmbOejxXbBshYIdaVtsQ6ApJokqFaMhk0HE=";
  };
  v1_20 = {
    version = "1.20.4";
    src-hash = "sha256-L4e+FwJYPsvu6CwK1NY1PelkY8+g+m51V+BfaNkNqGk=";
  };
}

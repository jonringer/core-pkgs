...
let
  ...
  autoreconfHook = args.autoreconfHook or autoconf.v2_69.autoreconfHook;
...
stdenv.mkDerivation {
  ...
  src =
    stdenv.__bootPackages.binutils.unwrapped.v2_38.src or srcs.${targetPlatform.system} or srcs.normal;

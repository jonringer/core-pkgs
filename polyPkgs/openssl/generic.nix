...
stdenv.mkDerivation (finalAttrs: {
  ...
  patches = lib.optionals (packageBetween "1" "3") [
    ./1.1/nix-ssl-cert-file.patch
    (if stdenv.hostPlatform.isDarwin
    then ./use-etc-ssl-certs-darwin.patch
    else ./use-etc-ssl-certs.patch)
  ] ++ lib.optionals (packageAtLeast "3") [
  ...
  meta = {
    ...
    license = if (packageAtLeast "3") then lib.licenses.asl20 else lib.licenses.openssl;
    mainProgram = "openssl";
    ...
    knownVulnerabilities = lib.optionals (packageOlder "3") [

...
mkAppleDerivation {
  ...
  postPatch = ''
    ...
    substitute ${buildPackages.AvailabilityVersions}/libexec/make_symbol_aliasing.sh bsd/sys/make_symbol_aliasing.sh \
  ...
  env = {
    ...
    LIPO = "echo";
    MIG = "mig";
    MIGCOM = "${lib.getBin buildPackages.bootstrap_cmds}/libexec/migcom";
    NMEDIT = "echo";
    UNIFDEF = "unifdef";

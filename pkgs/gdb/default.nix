...
# Run time
, ncurses, readline, gmp, mpfr, expat, libipt, zlib, zstd, xz, dejagnu, libiconv
, source-highlight
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ ncurses readline gmp mpfr expat libipt zlib zstd xz guile source-highlight ]
